...
<table style="margin:auto;width:100%">
  ...
  include 'connection.php';
  	$qu="SELECT * from request where FMobile='$_SESSION[mobile]'";
  	...
  	while($row=mysqli_fetch_array($doQu))
  	{
  		...
  		echo "<tr><td>$row[crop]</td><td>$row[season]</td><td>$row[sowdate]</td><td>$row[harvestdate]</td><td>$row[area]</td><td>$row[quantity]</td></tr>";
