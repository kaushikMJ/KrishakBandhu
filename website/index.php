        ...
        <div class="container">
          ...
          <div class="row">
            <div class="col-sm-3" style="margin:70px;">
              ...
              <a href="https://prebendal-scab.000webhostapp.com/FRegister.php?"><button type="button" class="btn btn-primary" style="float: left;">Farmers</button></a>
            </div>
            <div class="col-sm-3" style="margin:70px;">
                <p style="color:blue;text-align:left;">Buyers can login and view the requests placed by the farmer</p>
              <a href="https://prebendal-scab.000webhostapp.com/BRegister.php?"><button type="button" class="btn btn-primary" style="float: left;">Buyers</button></a>  
            </div>
          </div>
