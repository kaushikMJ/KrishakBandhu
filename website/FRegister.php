...
<html>
    ...
    <head>
        <h2 style="color:#0047AB;">Register Yourself</h2>
    ...
    <body style="background-color: #1BBA93;background-image: none">
    	...
    	include 'connection.php';
    		if(isset($_POST['submit']))
    		{
    			...
    			$emailQuery="SELECT email FROM farmer where email='$email'";
    			...
    			else
    			{
    				...
    				{
    					$insertQuery="INSERT into farmer(name,email,mobile,address,state,district,village,pincode,password,cpassword) VALUES('$name','$email','$mobile','$address','$state','$district','$village','$pincode','$pass','$cpass')";
        ...
        <table style="border-style: dashed;border-width: 8px;font-size: 18px;">
            <tr>
                <td>Your Name</td>
                <td><input type="text" required id="name" placeholder="Enter your name" name="name" /></td>
            </tr>
            <tr>
                <td>Email Id</td>
                <td><input type="email" required id="email" placeholder="Enter your email id" name="email" /></td>
            </tr>
            <tr>
                <td>Mobile No.</td>
                <td><input type="number" required id="mobile" placeholder="Enter your mobile no." name="mobile" /></td>
            </tr>
            <tr>
                <td>Address</td>
                <td><textarea rows="2" cols="25" required placeholder="Enter your address" name="address"></textarea></td>
            </tr>
            <tr>
                <td>State</td>
            ...
            <tr>
                <td>District/Tehsil</td>
                <td><input type="text" required placeholder="Enter district name" id="district" name="district"></td>
            </tr>
            <tr>
                <td>Village/Town</td>
                <td><input type="text" required placeholder="Enter village name" id="village" name="village"></td>
            </tr>
            <tr>
                <td>Pin Code</td>
        ...
        <div style="font-size:30px;text-decoration-color:red;" class="center">Already have an account?<a href="FLogin.php?doit=FLogin">SignIn</a></div>
