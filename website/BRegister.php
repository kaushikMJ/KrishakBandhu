...
<html>
    ...
    <head>
        ...
        <h2 style="color:#0047AB;">Register Yourself/<div style="font-size:30px;text-decoration-color:red;" class="center">Already have an account?<a href="BLogin.php?doit=BLogin">SignIn</a></div>
        </h2>
    </head>
    ...
    ?>
        ...
        <div class="footer" style="height: 35px;"><p>(c) Copyright 2022.Developed with <span>&#10084;&#65039;</span> by Kaushik and Souvik</p></div>
    </body>
</html>